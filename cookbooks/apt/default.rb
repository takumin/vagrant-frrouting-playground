  ...
  entry [
    {
      ...
      :mirror_uri  => "#{ENV['APT_REPO_URL_UBUNTU'] || node['apt-repo-url-ubuntu']}",
    ...
    },
    {
      :default_uri => 'http://jp.archive.ubuntu.com/ubuntu',
      :mirror_uri  => "#{ENV['APT_REPO_URL_UBUNTU'] || node['apt-repo-url-ubuntu']}",
      :suite       => "#{node['platform_codename']}-updates",
      :source      => true,
      :components  => [
        'main',
        'restricted',
    ...
    },
    {
      :default_uri => 'http://jp.archive.ubuntu.com/ubuntu',
      :mirror_uri  => "#{ENV['APT_REPO_URL_UBUNTU'] || node['apt-repo-url-ubuntu']}",
      :suite       => "#{node['platform_codename']}-backports",
      :source      => true,
      :components  => [
        'main',
        'restricted',
    ...
    },
    {
      :default_uri => 'http://jp.archive.ubuntu.com/ubuntu',
      :mirror_uri  => "#{ENV['APT_REPO_URL_UBUNTU'] || node['apt-repo-url-ubuntu']}",
      :suite       => "#{node['platform_codename']}-security",
      :source      => true,
      :components  => [
        'main',
        'restricted',
  ...
  entry [
    {
      ...
      :mirror_uri  => "#{ENV['APT_REPO_URL_PARTNER'] || node['apt-repo-url-partner']}",
      :suite       => '###platform_codename###',
      :source      => true,
      :components  => [
        'partner',
  ...
  entry [
    {
      ...
      :mirror_uri  => "#{ENV['APT_REPO_URL_JA'] || node['apt-repo-url-ja']}",
      :suite       => '###platform_codename###',
      :source      => true,
      :components  => [
        'main',
    ...
    },
    {
      ...
      :mirror_uri  => "#{ENV['APT_REPO_URL_JA_NON_FREE'] || node['apt-repo-url-ja-non-free']}",
      :suite       => '###platform_codename###',
      :source      => true,
      :components  => [
        'multiverse',
